    ...
    <main className="pb-40" data-lightbox>
      <section className="bg-gray-warm-200 px-10 pb-16 pt-44 lg:px-20 md:pt-36 xl:pt-44 2xl:pt-72 [@media(min-width:1280px)_and_(pointer:coarse)]:pt-52! 2xl:px-page-edge-2xl">
        <div className="mx-auto grid w-full max-w-screen-2xl grid-cols-12">
          ...
          >
            Accelerating due diligence at Malted
          </motion.h1>
          ...
          >
            I owned the end-to-end design of an AI-powered due diligence tool
            for S-RM, a global intelligence and cyber security consultancy. Over
            a 4-month period, we went from discovery to delivery of a system that
            analysts genuinely trusted and wanted to use. I worked closely with
            ML engineers on the data model and pipeline, building a tool that
            extracts and structures information from messy, multilingual
            documents into investigation briefs and final reports.
          </motion.p>
